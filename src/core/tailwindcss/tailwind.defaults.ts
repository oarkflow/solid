// Tailwind CSS Default Theme Values
// These are the default values that can be extended or overridden via tailwind.config.ts
...
export type ColorValue = string | ColorShades;
...
export interface ThemeMaxWidth {
    [key: string]: string;
}
...
export const defaultFontWeight: ThemeFontWeight = {
    'thin': '100',
    'extralight': '200',
    'light': '300',
    'normal': '400',
...
// Default Box Shadows
export const defaultBoxShadow: ThemeBoxShadow = {
    'sm': '0 1px 2px 0 rgb(var(--tw-shadow-color) / 0.05)',
    'DEFAULT': '0 1px 3px 0 rgb(var(--tw-shadow-color) / 0.1), 0 1px 2px -1px rgb(var(--tw-shadow-color) / 0.1)',
    'md': '0 4px 6px -1px rgb(var(--tw-shadow-color) / 0.1), 0 2px 4px -2px rgb(var(--tw-shadow-color) / 0.1)',
    'lg': '0 10px 15px -3px rgb(var(--tw-shadow-color) / 0.1), 0 4px 6px -4px rgb(var(--tw-shadow-color) / 0.1)',
    'xl': '0 20px 25px -5px rgb(var(--tw-shadow-color) / 0.1), 0 8px 10px -6px rgb(var(--tw-shadow-color) / 0.1)',
    '2xl': '0 25px 50px -12px rgb(var(--tw-shadow-color) / 0.25)',
    'inner': 'inset 0 2px 4px 0 rgb(var(--tw-shadow-color) / 0.05)',
    'none': 'none'
};

// Default Max Widths
export const defaultMaxWidth: ThemeMaxWidth = {
    'none': 'none',
    '0': '0rem',
    'xs': '20rem',
    'sm': '24rem',
...
export const defaultLineHeight: ThemeLineHeight = {
    'none': '1',
    'tight': '1.25',
    'snug': '1.375',
    'normal': '1.5',
...
export const defaultLetterSpacing: ThemeLetterSpacing = {
    'tighter': '-0.05em',
    'tight': '-0.025em',
    'normal': '0em',
    'wide': '0.025em',
